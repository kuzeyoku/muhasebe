...
@section("title", $licence->company?->name." - ".$licence->number." Ruhsat Dosyaları")
@section("content")
    {{html()->form()->route("licence.fileStore", $licence)->acceptsFiles()->open()}}
    <div class="mb-2">
    ...
    {{html()->form()->close()}}
    @if($licence->hasMedia("files"))
        <div class="row mt-3">
            @foreach($licence->getMedia("files") as $file)
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{html()->form("DELETE")->route("licence.fileDelete", [$licence,$file])->class("d-inline")->open()}}
