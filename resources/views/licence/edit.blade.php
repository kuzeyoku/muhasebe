<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        {{html()->form("PUT")->route("licence.update",$licence)->open()}}
        <div class="modal-body">
            ...
            <div class="row mb-2">
                <div class="col-lg-6">
                    ...
                    {{html()->select("city_id", $cities,$licence->city_id)->class("form-control")->id("city-select")->placeholder("Seçiniz")}}
                </div>
                <div class="col-lg-6">
                    {{html()->label("İlçe (Önce İl Seçiniz)", "district")->class("form-label")->for("district")}}
                    {{html()->select("district_id",$districts,$licence->district_id)->class("form-control")->id("district-select")->placeholder("Seçiniz")}}
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-lg-6">
            ...
            <div class="row mb-2">
                ...
                <div class="col-lg-6">
                    ...
                    {{html()->select("type",\App\Enums\LicenceTypeEnum::toSelectArray(),$licence->type)->class("form-control")->placeholder("Seçiniz")}}
                </div>
            </div>
