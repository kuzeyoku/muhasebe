        ...
        <div class="modal-body">
            @if($unpaidInvoices->count() > 0)
                <div class="alert alert-warning shadow-sm border-theme-white-2" role="alert">
                    ...
                    <strong>Dikkat !</strong> Firma tarafından 15 gün içerisinde ödenmesi
                        ...
                        <div class="card-body">
                            <div class="row d-flex justify-content-center">
                                <div class="col-9">
                                    ...
                                    <h4 class="mt-1 mb-0 fw-medium">{{$company->incomes->sum("amount")}}</h4>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="card bg-corner-img">
                        <div class="card-body">
                            <div class="row d-flex justify-content-center">
                                <div class="col-9">
                                    <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Toplam Kar</p>
