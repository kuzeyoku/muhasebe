        ...
        <div class="modal-body">
            ...
            <div class="row mb-2">
                <div class="col-lg-6">
                    ...
                    {{html()->select("city_id", $cities, $company->city_id)->class("form-control")->id("city_select")->placeholder("Seçiniz")}}
                </div>
                <div class="col-lg-6">
                    {{html()->label("İlçe", "district")->class("form-label")->for("district")}}
                    {{html()->select("district_id", $districts, $company->district_id)->class("form-control")->id("district_select")->placeholder("Seçiniz")}}
                </div>
            </div>
            <div class="mb-2">
