<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        {{html()->form()->route("admin.company.store")->acceptsFiles()->open()}}
        <div class="modal-body">
            ...
            <div class="row mb-2">
                <div class="col-lg-6">
                    ...
                    {{html()->select("city", $cities)->class("form-control")->id("city_select")->placeholder("Seçiniz")}}
                </div>
                <div class="col-lg-6">
                    {{html()->label("İlçe (Önce İl Seçiniz)", "district")->class("form-label")->for("district")}}
                    {{html()->select("district")->class("form-control")->id("district_select")->placeholder("Seçiniz")}}
                </div>
            </div>
            <div class="mb-2">
