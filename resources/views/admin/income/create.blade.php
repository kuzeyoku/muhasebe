<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        {{html()->form()->route("admin.income.store")->acceptsFiles()->open()}}
        <div class="modal-body">
            ...
            <div class="mb-2">
                ...
                {{html()->select("company_id",$companies)->class("form-control")->id("company_select")->placeholder("Firma Seçiniz")}}
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                {{html()->select("type",["business"=>"İş","personal"=>"Özel","other"=>"Diğer"])->class("form-control")->placeholder("Gelir Tipi")->required()}}
