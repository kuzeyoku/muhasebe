<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        {{html()->form("PUT")->route("admin.contract.update",$contract)->acceptsFiles()->open()}}
        <div class="modal-body">
            ...
            <div class="mb-2">
                ...
                {{html()->select("company_id", $companies,$contract->company_id)->class("form-control")->id("company_select")->placeholder("Firma Seçiniz")->required()}}
            </div>
            <div class="mb-2">
                {{html()->label("Ruhsat (Önce Firma Seçin)", "licence")->class("form-label")->for("licence")}}
                {{html()->select("licence_id",$licences,$contract->licence_id)->class("form-control")->id("licence_select")->placeholder("Firma Seçiniz")}}
            </div>
            <div class="row mb-2">
                <div class="col-lg-6">
