<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        {{html()->form("PUT")->route("admin.invoice.update",$invoice)->acceptsFiles()->open()}}
        <div class="modal-body">
            <div class="mb-2">
                {{html()->label("Fatura", "file")->class("form-label")->for("file")}}
                {{html()->file("file")->class("form-control")->multiple()}}
            </div>
            <div class="mb-2">
                {{html()->label("Firma", "company")->class("form-label")->for("company")}}
                {{html()->select("company_id",$companies,$invoice->company_id)->class("form-control")->id("company_select")->placeholder("Firma Seçiniz")}}
            </div>
            <div class="mb-2">
                {{html()->label("Ruhsat (Önce Firma Seçin)", "licence")->class("form-label")->for("licence")}}
                {{html()->select("licence_id",$licences,$invoice->licence_id)->class("form-control")->id("licence_select")->placeholder("Firma Seçiniz")}}
            </div>
            <div class="row mb-2">
                <div class="col-lg-6">
            ...
            <div class="row mb-2">
                <div class="col-lg-6">
                    ...
                    {{html()->text("amount",$invoice->amount)->class("form-control")->placeholder("Tutar")->required()}}
                </div>
                <div class="col-lg-6">
