...
@section("title", $contract->company?->name." - ".$contract->title." Sözleşmesi Dosyaları")
@section("content")
    {{html()->form()->route("contract.fileStore", $contract)->acceptsFiles()->open()}}
    <div class="mb-2">
    ...
    {{html()->form()->close()}}
    @if($contract->hasMedia("files"))
        <div class="row mt-3">
            @foreach($contract->getMedia("files") as $file)
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{html()->form("DELETE")->route("contract.fileDelete", [$contract,$file])->class("d-inline")->open()}}
    ...
    @else
        <div class="alert alert-purple shadow-sm border-theme-white-2 mb-0 mt-3" role="alert">
            ...
            Henüz Bu Sözleşme İçin Dosya Yüklenmemiştir.
        </div>
    @endif
